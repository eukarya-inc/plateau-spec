...
| 型の定義 | 建築物の外周を構成する壁面（外壁面）。![Image](images/_bldgwallsurface_img001.png)bldg:WallSurfaceの例カーテンウォールはbldg:WallSurfaceにより表現する。カーテンウォールとは、建築物の外側に配置され、建築物を囲む非耐荷重の壁である。 ［出典: ISO 6707-1] | ← |
| --- | --- | --- |
